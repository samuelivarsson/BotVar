...
module.exports = {
    ...
    aliases: ['skip', 'stop'],
    cooldown: 0,
    description: 'Play music by song name or a link.',
    async execute(message, args, cmd, client, Discord) {
        ...
        if (cmd === 'play') {
            ...
            if (ytdl.validateURL(args[0])) {
                ...
                // If the video is not a URL then use keywords to find the video.
...
async function connectToChannel(voice_channel) {
